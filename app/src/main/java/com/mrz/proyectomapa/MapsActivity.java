...
import com.mrz.proyectomapa.databinding.ActivityMapsBinding;
        ...
        locationTask.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null) {
                    ...
                    mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(currentLatLng, 15)); // Zoom a la ubicación actual
                }
            }
        });
    }
